 ...
 * @author mmaam
 */
public class BasicMathsLevel4 extends javax.swing.JInternalFrame {
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`maths` SET `basicMathsLevel4_Marks` = '" + fMarks + "', `basicMathsLevel4_Complete` = '" + Complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');");
            // execute query
            st1.executeUpdate();
    ...
    public void easyGameRandom() {
        ...
        int num2 = rnd.nextInt(1, 5);
        int num1 = rnd.nextInt(num2, 10);
