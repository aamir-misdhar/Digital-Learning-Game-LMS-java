 ...
 * @author mmaam
 */
public class BasicMathsLevel2 extends javax.swing.JInternalFrame {
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`maths` SET `basicMathsLevel2_Marks` = '" + fMarks + "', `basicMathsLevel2_Complete` = '" + Complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');");
            // execute query
            st1.executeUpdate();
