 ...
 * @author mmaam
 */
public class PerimeterAndAreaTriangle extends javax.swing.JFrame {

    /**
     * Creates new form PerimeterAndAreaTriangle
     */
    String RegisterId = "";
    ...
    public PerimeterAndAreaTriangle() {
        initComponents();
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                lblSidePnlSqureComplete.setText("Completed : " + perimeterAndAreaSquareComplete + "%");
                lblSidePnlSquareMarks.setText("Score : " + perimeterAndAreaSquareMarks);
            ...
            Logger.getLogger(PerimeterAndAreaRectangleF.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`maths` SET `perimeterAndAreaTriangle_Marks` = '" + marks + "', `perimeterAndAreaTriangle_Complete` = '" + complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');");
            // execute query
            st1.executeUpdate();
        } catch (SQLException ex) {
            Logger.getLogger(PerimeterAndAreaRectangleF.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void rendamNumbers() {
        ...
        int base = rnd.nextInt(5);
        int side2 = rnd.nextInt(5);
        int side3 = rnd.nextInt(5);
        int height = rnd.nextInt(5);

        lblBase.setText(base + "");
        lblSide2.setText(side2 + "");
        lblSide3.setText(side3 + "");
        lblHeight.setText(height + "");

        lblPerimeterQuestion.setText(base + " + " + side2 + " + " + side3);
        lblAreaQuestion.setText("<html><sup>1</sup>/<sub>2</sub> X " + base + " X " + height + "</html>");
    }
    ...
    public void perimeterCheck() {
        try {
            ...
            int base = Integer.valueOf(lblBase.getText());
            int side2 = Integer.valueOf(lblSide2.getText());
            int side3 = Integer.valueOf(lblSide3.getText());
            int height = Integer.valueOf(lblHeight.getText());
            
            int correctAns = base+side2+side3;
    ...
    private void initComponents() {
        ...
        lblSidePnlSqureComplete = new javax.swing.JLabel();
        lblSidePnlSquareMarks = new javax.swing.JLabel();
        ...
        lblSidePnlSqureComplete.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblSidePnlSqureComplete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlSqureComplete.setText("Completed : 0%");

        lblSidePnlSquareMarks.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblSidePnlSquareMarks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlSquareMarks.setText("Score : 00");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblSidePnlSqureComplete, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblSidePnlSquareMarks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblSidePnlSqureComplete)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblSidePnlSquareMarks)
                .addContainerGap(18, Short.MAX_VALUE))
        );
        ...
        lblBase.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        lblBase.setForeground(new java.awt.Color(102, 102, 102));
        lblBase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblBase.setText("jLabel18");
        jPanel4.add(lblBase, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, 90, -1));

        lblSide3.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        lblSide3.setForeground(new java.awt.Color(102, 102, 102));
        lblSide3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblSide3.setText("jLabel18");
        jPanel4.add(lblSide3, new org.netbeans.lib.awtextra.AbsoluteConstraints(98, 80, 90, -1));

        lblHeight.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        lblHeight.setForeground(new java.awt.Color(102, 102, 102));
        lblHeight.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblHeight.setText("jLabel18");
        jPanel4.add(lblHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 90, -1));

        lblSide2.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        lblSide2.setForeground(new java.awt.Color(102, 102, 102));
        lblSide2.setText("jLabel18");
        jPanel4.add(lblSide2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, 90, -1));

        PictureBox.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/PerimeterAndArea_Triangle.png"))); // NOI18N
        ...
        jLabel5.setText("Side 1 + Side 2 + Side 3");
        ...
        jLabel6.setText("<html><sup>1</sup>/<sub>2</sub> X Base X Height</html>");

        lblAreaQuestion.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerimeterAndAreaTriangle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerimeterAndAreaTriangle().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblSidePnlSquareMarks;
    private javax.swing.JLabel lblSidePnlSqureComplete;
