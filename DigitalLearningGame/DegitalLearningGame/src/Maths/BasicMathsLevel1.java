 ...
 * @author mmaam
 */
public class BasicMathsLevel1 extends javax.swing.JInternalFrame {

    /**
     * Creates new form BasicMathsLevel1
     */
    String RegisterId;
    int fMarks = 0;
    int Complete = 0;

    public BasicMathsLevel1() {
        initComponents();
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`maths` SET `basicMathsLevel1_Marks` = '" + fMarks + "', `basicMathsLevel1_Complete` = '" + Complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');");
            // execute query
            st1.executeUpdate();
