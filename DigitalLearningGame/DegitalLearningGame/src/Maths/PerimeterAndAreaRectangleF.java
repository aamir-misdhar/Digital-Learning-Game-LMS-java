 ...
 * @author mmaam
 */
public class PerimeterAndAreaRectangleF extends javax.swing.JFrame {

    /**
     * Creates new form PerimeterAndAreaRectangleF
     */
    String RegisterId = "";
    ...
    public PerimeterAndAreaRectangleF() {
        initComponents();
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`maths` SET `perimeterAndAreaRectangle_Marks` = '" + marks + "', `perimeterAndAreaRectangle_Complete` = '" + complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');");
            // execute query
            st1.executeUpdate();
        } catch (SQLException ex) {
            Logger.getLogger(PerimeterAndAreaRectangleF.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void rendamNumbers() {
        ...
        int widht = rnd.nextInt(1, 10);

        lblWidht.setText(widht + "");
        lblHeght.setText(height + "");

        lblPerimeterQuestion.setText("2 ( " + widht + " + " + height + " )");
        lblAreaQuestion.setText(widht + " X " + height);
    }
    ...
    public void perimeterCheck() {
        try {
            ...
            int correctAns = width + width + height + height;
    ...
    private void initComponents() {
        ...
        PictureBox.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/PerimeterAndArea_Rectangle.png"))); // NOI18N
        ...
        jLabel5.setText("2 (Width + Height)");
        ...
        jLabel6.setText("Widht X Height");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerimeterAndAreaRectangleF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerimeterAndAreaRectangleF().setVisible(true);
            }
        });
    }
