 ...
 * @author mmaam
 */
public class NumberSystemAdditionBase10 extends javax.swing.JFrame {

    /**
     * Creates new form NumberSystemAdditionBase10
     */
    String txtText = "";
    ...
    public NumberSystemAdditionBase10() {
        initComponents();
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //Set data
                lblSidePnlAdditionBase8Complete.setText("Completed : " + numberSystemAddition8_complete + "%");
                lblSidePnlAdditionBase8Marks.setText("Score : " + numberSystemAddition8_marks);
                
                lblSidePnlAdditionBase2Complete.setText("Completed : " + numberSystemAddition2_complete + "%");
                lblSidePnlAdditionBase2Marks.setText("Score : " + numberSystemAddition2_marks);
                
                lblSidePnlAdditionBase16Complete.setText("Completed : " + numberSystemAddition16_complete + "%");
                lblSidePnlAdditionBase16Marks.setText("Score : " + numberSystemAddition16_marks);
                
                

            }
        } catch (SQLException ex) {
            Logger.getLogger(NumberSystemAdditionBase10.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void sendDataToDatabase() {
        try {
            ...
            String sql = "UPDATE `digital_learning_game`.`ict` SET `numberSystemAddition10_marks` = '" + marks + "', `numberSystemAddition10_complete` = '" + complete + "' WHERE (`stdRegisterId` = '" + RegisterId + "');";
    ...
    public void rendomNumbers() {
        ...
        int num1Pos1 = rnd.nextInt(0, 10);
        int num1Pos2 = rnd.nextInt(0, 10);
        int num1Pos3 = rnd.nextInt(0, 10);
        int num1Pos4 = rnd.nextInt(0, 10);

        int num2Pos1 = rnd.nextInt(0, 10);
        int num2Pos2 = rnd.nextInt(0, 10);
        int num2Pos3 = rnd.nextInt(0, 10);
        int num2Pos4 = rnd.nextInt(0, 10);
    ...
    public void checkBalance() {
        ...
        try {
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 10) {
                if (balPos2 == 0) {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 20) {
                if (balPos2 == 10) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 30) {
                if (balPos2 == 20) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 10) {
                if (balPos3 == 0) {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 20) {
                if (balPos3 == 10) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 30) {
                if (balPos3 == 20) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 10) {
                if (balPos4 == 0) {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 20) {
                if (balPos4 == 10) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 30) {
                if (balPos4 == 20) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
    ...
    public void checkNetTotal() {
        try {
            ...
            if (num1Pos1 + num2Pos1 < 10) {
                ...
                if (netTtlPos1 == num1Pos1 + num2Pos1 - 10) {
                    txtNetTtlPos1.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos1.setForeground(Color.red);
                ...
                if (netTtlPos1 == num1Pos1 + num2Pos1 - 20) {
                    txtNetTtlPos1.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos1.setForeground(Color.red);
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 10) {
                ...
                if (netTtlPos2 == num1Pos2 + num2Pos2 + topBalncPos2 - 10) {
                    txtNetTtlPos2.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos2.setForeground(Color.red);
                ...
                if (netTtlPos2 == num1Pos2 + num2Pos2 + topBalncPos2 - 20) {
                    txtNetTtlPos2.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos2.setForeground(Color.red);
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 10) {
                ...
                if (netTtlPos3 == num1Pos3 + num2Pos3 + topBalncPos3 - 10) {
                    txtNetTtlPos3.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos3.setForeground(Color.red);
                ...
                if (netTtlPos3 == num1Pos3 + num2Pos3 + topBalncPos3 - 20) {
                    txtNetTtlPos3.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos3.setForeground(Color.red);
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 10) {
                ...
                if (netTtlPos4 == num1Pos4 + num2Pos4 + topBalncPos4 - 10) {
                    txtNetTtlPos4.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos4.setForeground(Color.red);
                ...
                if (netTtlPos4 == num1Pos4 + num2Pos4 + topBalncPos4 - 20) {
                    txtNetTtlPos4.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos4.setForeground(Color.red);
    ...
    private void initComponents() {
        ...
        lblSidePnlAdditionBase8Complete = new javax.swing.JLabel();
        lblSidePnlAdditionBase8Marks = new javax.swing.JLabel();
        ...
        lblSidePnlAdditionBase2Complete = new javax.swing.JLabel();
        lblSidePnlAdditionBase2Marks = new javax.swing.JLabel();
        jPanel14 = new javax.swing.JPanel();
        jLabel11 = new javax.swing.JLabel();
        jProgressBar3 = new javax.swing.JProgressBar();
        lblSidePnlAdditionBase16Complete = new javax.swing.JLabel();
        lblSidePnlAdditionBase16Marks = new javax.swing.JLabel();
        ...
        jLabel9.setText("Addition Base 8");

        lblSidePnlAdditionBase8Complete.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblSidePnlAdditionBase8Complete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase8Complete.setText("Completed : 0%");

        lblSidePnlAdditionBase8Marks.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblSidePnlAdditionBase8Marks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase8Marks.setText("Score : 00");
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblSidePnlAdditionBase8Complete, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblSidePnlAdditionBase8Marks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addComponent(lblSidePnlAdditionBase8Complete)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblSidePnlAdditionBase8Marks)
        ...
        jLabel10.setText("Addition Base 2");

        lblSidePnlAdditionBase2Complete.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblSidePnlAdditionBase2Complete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase2Complete.setText("Completed : 0%");

        lblSidePnlAdditionBase2Marks.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblSidePnlAdditionBase2Marks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase2Marks.setText("Score : 00");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblSidePnlAdditionBase2Complete, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblSidePnlAdditionBase2Marks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblSidePnlAdditionBase2Complete)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblSidePnlAdditionBase2Marks)
                .addContainerGap(18, Short.MAX_VALUE))
        );
        ...
        jLabel11.setText("Addition Base 16");

        lblSidePnlAdditionBase16Complete.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblSidePnlAdditionBase16Complete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase16Complete.setText("Completed : 0%");

        lblSidePnlAdditionBase16Marks.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblSidePnlAdditionBase16Marks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase16Marks.setText("Score : 00");
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblSidePnlAdditionBase16Complete, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblSidePnlAdditionBase16Marks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblSidePnlAdditionBase16Complete)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblSidePnlAdditionBase16Marks)
                .addContainerGap(18, Short.MAX_VALUE))
        );
        ...
        jLabel2.setText("Addition Base 10");
    ...
    private void txtBalPos1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBalPos1FocusLost
        ...
        try {
            if (focustFeild.getText().equals("")) {
                ...
                if (Integer.valueOf(focustFeild.getText()) < 10) {
                    focusedLabel.setText("0");
                } else if (Integer.valueOf(focustFeild.getText()) < 20) {
                    focusedLabel.setText("1");
                } else if (Integer.valueOf(focustFeild.getText()) < 30) {
    ...
    //============================================================== TextBox Net Total Forcus Gained ===========================================================/
...
// ===================================================== Keyboard Control ==================================================================/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumberSystemAdditionBase10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NumberSystemAdditionBase10().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblSidePnlAdditionBase16Complete;
    private javax.swing.JLabel lblSidePnlAdditionBase16Marks;
    private javax.swing.JLabel lblSidePnlAdditionBase2Complete;
    private javax.swing.JLabel lblSidePnlAdditionBase2Marks;
    private javax.swing.JLabel lblSidePnlAdditionBase8Complete;
    private javax.swing.JLabel lblSidePnlAdditionBase8Marks;
