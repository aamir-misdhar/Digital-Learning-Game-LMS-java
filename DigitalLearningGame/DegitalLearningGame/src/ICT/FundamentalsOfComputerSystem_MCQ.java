 ...
 * @author mmaam
 */
public class FundamentalsOfComputerSystem_MCQ extends javax.swing.JFrame {

    /**
     * Creates new form FundamentalsOfComputerSystem_MCQ
     */
    String RegisterId = "";
    ...
    public FundamentalsOfComputerSystem_MCQ() {
        initComponents();
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            String sql = "SELECT fundamentalsOfcompSysFillInTheBlanks_completed,fundamentalsOfcompSysFillInTheBlanks_marks FROM digital_learning_game.ict where stdRegisterId=?;";
            PreparedStatement st = con.prepareStatement(sql);
            st.setString(1, ID);
            ResultSet rs = st.executeQuery();
            while (rs.next()) {
                String fillInTheBlanksComplete = rs.getString("fundamentalsOfcompSysFillInTheBlanks_completed");
                String fillInTheBlanksMarks = rs.getString("fundamentalsOfcompSysFillInTheBlanks_marks");
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`ict` SET `fundamentalsOfcompSysMCQ_marks` = '"+marks+"', `fundamentalsOfcompSysMCQ_complete` = '"+complete+"' WHERE (`stdRegisterId` = '"+RegisterId+"');");
            // execute query
            st1.executeUpdate();
    ...
    public void questonChange() {
        ...
        if (questonNumber == 1) {
            ...
            labelMarks = lblMrks1;
            lblQstn.setText("<html>What is the primary function of a computer?</html>");
            radioAns1.setText("Storing data");
            radioAns2.setText("Processing data");
            radioAns3.setText("Retrieving data");
            radioAns4.setText("Displaying data");
            correctAnswer = radioAns2.getText();
        } else if (questonNumber == 2) {
            labelQuestion = lblQstn2;
            labelMarks = lblMrks2;
            lblQstn.setText("<html>Which characteristic of a computer refers to its ability to perform tasks without errors?</html>");
            radioAns1.setText("Speed");
            radioAns2.setText("Accuracy");
            radioAns3.setText("Efficiency");
            radioAns4.setText("Versatility");
            correctAnswer = radioAns2.getText();
        } else if (questonNumber == 3) {
            labelQuestion = lblQstn3;
            labelMarks = lblMrks3;
            lblQstn.setText("<html>Which type of computer is suitable for complex calculations and simulations?</html>");
            radioAns1.setText("Personal Computer");
            radioAns2.setText("Mainframe Computer");
            radioAns3.setText("Mini Computer");
            radioAns4.setText("Super Computer");
            correctAnswer = radioAns4.getText();
        } else if (questonNumber == 4) {
            labelQuestion = lblQstn4;
            labelMarks = lblMrks4;
            lblQstn.setText("<html>What is the primary purpose of the ALU (Arithmetic and Logical Unit) in a CPU?</html>");
            radioAns1.setText("Managing control operations");
            radioAns2.setText("Temporary storage of data");
            radioAns3.setText("Performing mathematical and logical operations");
            radioAns4.setText("Displaying output");
            correctAnswer = radioAns3.getText();
        } else if (questonNumber == 5) {
            labelQuestion = lblQstn5;
            labelMarks = lblMrks5;
            lblQstn.setText("<html>Which type of transmission mode allows data to flow in both directions but not simultaneously?</html>");
            radioAns1.setText("Simplex-Mode");
            radioAns2.setText("Half-Duplex Mode");
            radioAns3.setText("Full-Duplex Mode");
            radioAns4.setText("Hybrid Mode");
            correctAnswer = radioAns2.getText();
        } else if (questonNumber == 6) {
            labelQuestion = lblQstn6;
            labelMarks = lblMrks6;
            lblQstn.setText("<html>What is the main function of switches, routers, and modems in a computer network?</html>");
            radioAns1.setText("Processing data");
            radioAns2.setText("Providing power");
            radioAns3.setText("Facilitating connectivity");
            radioAns4.setText("Storing data");
            correctAnswer = radioAns3.getText();
        } else if (questonNumber == 7) {
            labelQuestion = lblQstn7;
            labelMarks = lblMrks7;
            lblQstn.setText("<html>Which network type covers a city-wide area?</html>");
            radioAns1.setText("LAN (Local Area Network)");
            radioAns2.setText("MAN (Metropolitan Area Network)");
            radioAns3.setText("WAN (Wide Area Network)");
            radioAns4.setText("PAN (Personal Area Network)");
            correctAnswer = radioAns2.getText();
        } else if (questonNumber == 8) {
            labelQuestion = lblQstn8;
            labelMarks = lblMrks8;
            lblQstn.setText("<html>In computer networking, what does LAN stand for?</html>");
            radioAns1.setText("Local Access Network");
            radioAns2.setText("Long Area Network");
            radioAns3.setText("Local Area Network");
            radioAns4.setText("Logical Area Network");
            correctAnswer = radioAns3.getText();
        } else if (questonNumber == 9) {
            labelQuestion = lblQstn9;
            labelMarks = lblMrks9;
            lblQstn.setText("<html>Which topology connects all devices to a central hub or switch?</html>");
            radioAns1.setText("Bus Topology");
            radioAns2.setText("Ring Topology");
            radioAns3.setText("Mesh Topology");
            radioAns4.setText("Star Topology");
            correctAnswer = radioAns4.getText();
        } else if (questonNumber == 10) {
            labelQuestion = lblQstn10;
            labelMarks = lblMrks10;
            lblQstn.setText("<html>What are the two types of data transmission mediums mentioned in the notes?</html>");
            radioAns1.setText("Guided and Circular");
            radioAns2.setText("Wireless and Analog");
            radioAns3.setText("Guided and Wireless");
            radioAns4.setText("Digital and Hybrid");
            correctAnswer = radioAns3.getText();
        } else {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("FundamentalsOf a Computer System");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FundamentalsOfComputerSystem fandamantalsOfCompSys = new FundamentalsOfComputerSystem();
        fandamantalsOfCompSys.Setdata(RegisterId);
        fandamantalsOfCompSys.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FundamentalsOfComputerSystem_MCQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FundamentalsOfComputerSystem_MCQ().setVisible(true);
            }
        });
    }
