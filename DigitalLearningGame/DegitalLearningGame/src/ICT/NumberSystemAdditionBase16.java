 ...
 * @author mmaam
 */
public class NumberSystemAdditionBase16 extends javax.swing.JFrame {

    /**
     * Creates new form NumberSystemAdditionBase16
     */
    String txtText = "";
    ...
    public NumberSystemAdditionBase16() {
        initComponents();
        rendomNumbers();
    }
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                lblSidePnlAdditionBase10Complete.setText("Completed : " + numberSystemAddition10_complete + "%");
                lblSidePnlAdditionBase10Marks.setText("Score : " + numberSystemAddition10_marks);
            }
        } catch (SQLException ex) {
            Logger.getLogger(NumberSystemAdditionBase16.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void sendDataToDatabase() {
        try {
            ...
            String sql = "UPDATE `digital_learning_game`.`ict` SET `numberSystemAddition16_marks` = '"+marks+"', `numberSystemAddition16_complete` = '"+complete+"' WHERE (`stdRegisterId` = '"+RegisterId+"');";
    ...
    public void rendomNumbers() {
        ...
        int num1Pos1 = rnd.nextInt(0, 16);
        int num1Pos2 = rnd.nextInt(0, 16);
        int num1Pos3 = rnd.nextInt(0, 16);
        int num1Pos4 = rnd.nextInt(0, 16);

        int num2Pos1 = rnd.nextInt(0, 16);
        int num2Pos2 = rnd.nextInt(0, 16);
        int num2Pos3 = rnd.nextInt(0, 16);
        int num2Pos4 = rnd.nextInt(0, 16);
    ...
    public void checkBalance() {
        ...
        try {
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 16) {
                if (balPos2 == 0) {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 32) {
                if (balPos2 == 16) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 44) {
                if (balPos2 == 32) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 16) {
                if (balPos3 == 0) {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 32) {
                if (balPos3 == 16) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 44) {
                if (balPos3 == 32) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 16) {
                if (balPos4 == 0) {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 32) {
                if (balPos4 == 16) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 44) {
                if (balPos4 == 32) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
    ...
    public void checkNetTotal() {
        try {
            ...
            if (num1Pos1 + num2Pos1 < 16) {
                ...
                if (netTtlPos1 == num1Pos1 + num2Pos1 - 32) {
                    txtNetTtlPos1.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos1.setForeground(Color.red);
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 16) {
                ...
                if (netTtlPos2 == num1Pos2 + num2Pos2 + topBalncPos2 - 32) {
                    txtNetTtlPos2.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos2.setForeground(Color.red);
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 16) {
                ...
                if (netTtlPos3 == num1Pos3 + num2Pos3 + topBalncPos3 - 32) {
                    txtNetTtlPos3.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos3.setForeground(Color.red);
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 16) {
                ...
                if (netTtlPos4 == num1Pos4 + num2Pos4 + topBalncPos4 - 32) {
                    txtNetTtlPos4.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos4.setForeground(Color.red);
    ...
    private void initComponents() {
        ...
        lblSidePnlAdditionBase10Complete = new javax.swing.JLabel();
        lblSidePnlAdditionBase10Marks = new javax.swing.JLabel();
        ...
        jLabel9.setText("Addition Base 10");

        lblSidePnlAdditionBase10Complete.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblSidePnlAdditionBase10Complete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase10Complete.setText("Completed : 0%");

        lblSidePnlAdditionBase10Marks.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblSidePnlAdditionBase10Marks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblSidePnlAdditionBase10Marks.setText("Score : 00");
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblSidePnlAdditionBase10Complete, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lblSidePnlAdditionBase10Marks, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addComponent(lblSidePnlAdditionBase10Complete)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblSidePnlAdditionBase10Marks)
        ...
        jLabel11.setText("Addition Base 8");
        ...
        jLabel2.setText("Addition Base 16");
        ...
        btnNum100.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnNum100.setText("156");
        ...
        btnNum70.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnNum70.setText("108");
        ...
        btnNum80.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnNum80.setText("124");
        ...
        btnNum90.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnNum90.setText("140");
    ...
    private void txtBalPos4FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBalPos4FocusLost
        ...
        try {
            if (focustFeild.getText().equals("")) {
                ...
                if (Integer.valueOf(focustFeild.getText()) < 16) {
                    focusedLabel.setText("0");
                } else if (Integer.valueOf(focustFeild.getText()) < 32) {
                    focusedLabel.setText("1");
                } else if (Integer.valueOf(focustFeild.getText()) < 44) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumberSystemAdditionBase16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NumberSystemAdditionBase16().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblSidePnlAdditionBase10Complete;
    private javax.swing.JLabel lblSidePnlAdditionBase10Marks;
