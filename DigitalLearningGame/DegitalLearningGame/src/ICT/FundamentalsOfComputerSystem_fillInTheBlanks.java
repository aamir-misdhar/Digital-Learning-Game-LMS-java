 ...
 * @author mmaam
 */
public class FundamentalsOfComputerSystem_fillInTheBlanks extends javax.swing.JFrame {
    ...
    public FundamentalsOfComputerSystem_fillInTheBlanks() {
        initComponents();
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            String sql = "SELECT fundamentalsOfcompSysMCQ_complete,fundamentalsOfcompSysMCQ_marks FROM digital_learning_game.ict where stdRegisterId=?;";
            PreparedStatement st = con.prepareStatement(sql);
            st.setString(1, ID);
            ResultSet rs = st.executeQuery();
            while (rs.next()) {
                 String mcqComplete = rs.getString("fundamentalsOfcompSysMCQ_complete");
                String mcqMarks = rs.getString("fundamentalsOfcompSysMCQ_marks");
            ...
            Logger.getLogger(FundamentalsOfComputerSystem_fillInTheBlanks.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            Connection con = Database.db.getConnection();
    ...
    public void sendDataToDatabase() {
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `digital_learning_game`.`ict` SET `fundamentalsOfcompSysFillInTheBlanks_marks` = '"+marks+"', `fundamentalsOfcompSysFillInTheBlanks_completed` = '"+complete+"' WHERE (`stdRegisterId` = '"+RegisterId+"');");
            // execute query
            st1.executeUpdate();
    ...
    public void questionChange() {
        ...
        if (questionNumber == 1) {
            lblQuestion.setText("<htmL>A computer is an electronic device that ________________ data, processes them according to the instructions given, and produces the desired output.</htmL>");
            btnAnswer1.setText("Transmits");
            btnAnswer2.setText("Generates");
            btnAnswer3.setText("Accepts");
            btnAnswer4.setText("Encrypts");
            correctAnswer = "Accepts";
            sideQeustion = lblQstn1;
            sideMarks = lblMrks1;
        } else if (questionNumber == 2) {
            lblQuestion.setText("<html>The characteristics of a computer include speed, accuracy, efficiency, versatility, and ________________ ability.</html>");
            btnAnswer1.setText("Analyzing");
            btnAnswer2.setText("Calculating");
            btnAnswer3.setText("Storing");
            btnAnswer4.setText("Retrieving");
            correctAnswer = "Retrieving";
            sideQeustion = lblQstn2;
            sideMarks = lblMrks2;
        } else if (questionNumber == 3) {
            lblQuestion.setText("<html>Classification of computers according to size includes Super Computers, Mainframe computers, Mini computers, and Personal/Micro Computers/Mini Computers. Another classification is based on ________________.</html>");
            btnAnswer1.setText("Performance");
            btnAnswer2.setText("Technology");
            btnAnswer3.setText("Color");
            btnAnswer4.setText("Shape");
            correctAnswer = "Technology";
            sideQeustion = lblQstn3;
            sideMarks = lblMrks3;
        } else if (questionNumber == 4) {
            lblQuestion.setText("<html>Basic components of a computer include input devices, output devices, Central Processing Unit (CPU), primary memory, and ________________.</html>");
            btnAnswer1.setText("Peripheral devices");
            btnAnswer2.setText("External devices");
            btnAnswer3.setText("Secondary storage");
            btnAnswer4.setText("Power supply");
            correctAnswer = "Secondary storage";
            sideQeustion = lblQstn4;
            sideMarks = lblMrks4;
        } else if (questionNumber == 5) {
            lblQuestion.setText("<html>External devices are connected to a computer through ________________.</html>");
            btnAnswer1.setText("Cables");
            btnAnswer2.setText("Wires");
            btnAnswer3.setText("Ports");
            btnAnswer4.setText("Adapters");
            correctAnswer = "Ports";
            sideQeustion = lblQstn5;
            sideMarks = lblMrks5;
        } else if (questionNumber == 6) {
            lblQuestion.setText("<html>Modes of data transmission include simplex-mode, half-duplex mode, and full-duplex mode. Data transmission mediums are categorized into ________________ and unguided/wireless.</html>");
            btnAnswer1.setText("Wired");
            btnAnswer2.setText("Physical");
            btnAnswer3.setText("Guided");
            btnAnswer4.setText("Wired and Guided");
            correctAnswer = "Wired and Guided";
            sideQeustion = lblQstn6;
            sideMarks = lblMrks6;
        } else if (questionNumber == 7) {
            lblQuestion.setText("<html>Connectivity devices such as switches, routers, and modems are necessary to build a ________________.</html>");
            btnAnswer1.setText("Database");
            btnAnswer2.setText("Network");
            btnAnswer3.setText("Firewall");
            btnAnswer4.setText("Peripheral");
            correctAnswer = "Network";
            sideQeustion = lblQstn7;
            sideMarks = lblMrks7;
        } else if (questionNumber == 8) {
            lblQuestion.setText("<html>Types of computer networks include LAN, MAN, and ________________.</html>");
            btnAnswer1.setText("WAN");
            btnAnswer2.setText("VPN");
            btnAnswer3.setText("WLAN");
            btnAnswer4.setText("PAN");
            correctAnswer = "WAN";
            sideQeustion = lblQstn8;
            sideMarks = lblMrks8;
        } else if (questionNumber == 9) {
            lblQuestion.setText("<html>Computer network topology includes star topology, bus topology, ring topology, tree topology, and ________________.</html>");
            btnAnswer1.setText("Web topology");
            btnAnswer2.setText("Point-to-Point topology");
            btnAnswer3.setText("Mesh topology");
            btnAnswer4.setText("Hierarchical topology");
            correctAnswer = "Mesh topology";
            sideQeustion = lblQstn9;
            sideMarks = lblMrks9;
        } else if (questionNumber == 10) {
            lblQuestion.setText("<html>There are advantages as well as disadvantages of ________________.</html>");
            btnAnswer1.setText("Computer hardware");
            btnAnswer2.setText("Software development");
            btnAnswer3.setText("Internet usage");
            btnAnswer4.setText("Computer networking");
            correctAnswer = "Computer networking";
...
//            sideMarks = lblMrks4;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FundamentalsOfComputerSystem fundamentalsOfCompSys = new FundamentalsOfComputerSystem();
        fundamentalsOfCompSys.Setdata(RegisterId);
        fundamentalsOfCompSys.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FundamentalsOfComputerSystem_fillInTheBlanks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FundamentalsOfComputerSystem_fillInTheBlanks().setVisible(true);
            }
        });
    }
