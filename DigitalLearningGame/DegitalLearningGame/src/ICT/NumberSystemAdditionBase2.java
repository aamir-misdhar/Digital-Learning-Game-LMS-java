 ...
 * @author mmaam
 */
public class NumberSystemAdditionBase2 extends javax.swing.JFrame {

    /**
     * Creates new form NumberSystemAdditionBase2
     */
    String txtText = "";
    ...
    public NumberSystemAdditionBase2() {
        initComponents();
        rendomNumbers();
    }
    ...
    public void Setdata(String ID) {
        ...
        try {
            ...
            Logger.getLogger(NumberSystemAdditionBase2.class.getName()).log(Level.SEVERE, null, ex);
        }
        // Set User datails
        try {
            Connection con = Database.db.getConnection();
    ...
    public void sendDataToDatabase() {
        try {
            ...
            String sql = "UPDATE `digital_learning_game`.`ict` SET `numberSystemAddition2_marks` = '"+marks+"', `numberSystemAddition2_complete` = '"+complete+"' WHERE (`stdRegisterId` = '"+RegisterId+"');";
    ...
    public void rendomNumbers() {
        ...
        int num1Pos1 = rnd.nextInt(0, 2);
        int num1Pos2 = rnd.nextInt(0, 2);
        int num1Pos3 = rnd.nextInt(0, 2);
        int num1Pos4 = rnd.nextInt(0, 2);

        int num2Pos1 = rnd.nextInt(0, 2);
        int num2Pos2 = rnd.nextInt(0, 2);
        int num2Pos3 = rnd.nextInt(0, 2);
        int num2Pos4 = rnd.nextInt(0, 2);
    ...
    public void checkBalance() {
        ...
        try {
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 2) {
                if (balPos2 == 0) {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 4) {
                if (balPos2 == 2) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos2 + num2Pos2 + topBalncPos2 < 6) {
                if (balPos2 == 4) {
                    txtBalPos2.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 2) {
                if (balPos3 == 0) {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 4) {
                if (balPos3 == 2) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos3 + num2Pos3 + topBalncPos3 < 6) {
                if (balPos3 == 4) {
                    txtBalPos3.setForeground(Color.green);
                    correct++;
                } else {
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 2) {
                if (balPos4 == 0) {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 4) {
                if (balPos4 == 2) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
            ...
            } else if (num1Pos4 + num2Pos4 + topBalncPos4 < 6) {
                if (balPos4 == 4) {
                    txtBalPos4.setForeground(Color.green);
                    correct++;
                } else {
    ...
    public void checkNetTotal() {
        try {
            ...
            if (num1Pos1 + num2Pos1 < 2) {
                ...
                if (netTtlPos1 == num1Pos1 + num2Pos1 - 2) {
                    txtNetTtlPos1.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos1.setForeground(Color.red);
                ...
                if (netTtlPos1 == num1Pos1 + num2Pos1 - 4) {
                    txtNetTtlPos1.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos1.setForeground(Color.red);
            ...
            if (num1Pos2 + num2Pos2 + topBalncPos2 < 2) {
                ...
                if (netTtlPos2 == num1Pos2 + num2Pos2 + topBalncPos2 - 2) {
                    txtNetTtlPos2.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos2.setForeground(Color.red);
                ...
                if (netTtlPos2 == num1Pos2 + num2Pos2 + topBalncPos2 - 4) {
                    txtNetTtlPos2.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos2.setForeground(Color.red);
            ...
            if (num1Pos3 + num2Pos3 + topBalncPos3 < 2) {
                ...
                if (netTtlPos3 == num1Pos3 + num2Pos3 + topBalncPos3 - 2) {
                    txtNetTtlPos3.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos3.setForeground(Color.red);
                ...
                if (netTtlPos3 == num1Pos3 + num2Pos3 + topBalncPos3 - 4) {
                    txtNetTtlPos3.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos3.setForeground(Color.red);
            ...
            if (num1Pos4 + num2Pos4 + topBalncPos4 < 2) {
                ...
                if (netTtlPos4 == num1Pos4 + num2Pos4 + topBalncPos4 - 2) {
                    txtNetTtlPos4.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos4.setForeground(Color.red);
                ...
                if (netTtlPos4 == num1Pos4 + num2Pos4 + topBalncPos4 - 4) {
                    txtNetTtlPos4.setForeground(Color.green);
                    correct++;
                } else {
                    txtNetTtlPos4.setForeground(Color.red);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Addition Base 8");
        ...
        jLabel2.setText("Addition Base 2");
    ...
    private void txtBalPos4FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBalPos4FocusLost
        ...
        try {
            if (focustFeild.getText().equals("")) {
                ...
                if (Integer.valueOf(focustFeild.getText()) < 2) {
                    focusedLabel.setText("0");
                } else if (Integer.valueOf(focustFeild.getText()) < 4) {
                    focusedLabel.setText("1");
                } else if (Integer.valueOf(focustFeild.getText()) < 6) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumberSystemAdditionBase2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NumberSystemAdditionBase2().setVisible(true);
            }
        });
    }
